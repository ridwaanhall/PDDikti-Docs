...
Dokumentasi ini menjelaskan cara menggunakan endpoint `Statistik Jumlah Mahasiswa` dan bagaimana struktur response yang akan Kamu terima. Dengan endpoint ini, Kamu dapat melihat informasi jumlah total mahasiswa terdaftar.

## Endpoint

Untuk mendapatkan informasi jumlah total mahasiswa terdaftar, Kamu dapat menggunakan endpoint berikut:
...
<Tabs defaultValue="python" className="pt-5 pb-1">
  ...
  <TabsContent value="python">
    ...
    url = "https://api-pddikti.ridwaanhall.com/stats/mhs-count"
    api_url = f"{url}/"
  ...
  <TabsContent value="direct">
    Klik untuk mengakses [API directly](https://api-pddikti.ridwaanhall.com/stats/mhs-count/) atau copy text dibawah ini.

    ```plaintext
    https://api-pddikti.ridwaanhall.com/stats/mhs-count/
    ```
