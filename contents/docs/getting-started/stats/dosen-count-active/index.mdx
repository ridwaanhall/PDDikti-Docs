---
title: Dosen Aktif
description: Informasi jumlah total dosen aktif terdaftar.
---

Dokumentasi ini menjelaskan cara menggunakan endpoint `Statistik Jumlah Dosen Aktif` dan bagaimana struktur response yang akan Kamu terima. Dengan endpoint ini, Kamu dapat melihat informasi jumlah total dosen aktif terdaftar.

## Endpoint

Untuk mendapatkan informasi jumlah total dosen aktif terdaftar, Kamu dapat menggunakan endpoint berikut:

```plaintext
GET /stats/dosen-count-active/
```
...
> Dalam contoh ini, API akan mencoba mengambil informasi jumlah total dosen aktif terdaftar.
...
<Tabs defaultValue="python" className="pt-5 pb-1">
  ...
  <TabsContent value="python">
    ...
    url = "https://api-pddikti.ridwaanhall.com/stats/dosen-count-active"
    api_url = f"{url}/"
  ...
  <TabsContent value="direct">
    Klik untuk mengakses [API directly](https://api-pddikti.ridwaanhall.com/stats/dosen-count-active/) atau copy text dibawah ini.

    ```plaintext
    https://api-pddikti.ridwaanhall.com/stats/dosen-count-active/
    ```
...
Response ini berisi informasi jumlah total dosen aktif terdaftar.
...
<Tabs defaultValue="hasil" className="pt-5 pb-1">
  ...
  <TabsContent value="hasil">
    ...
    ```
    - **Jumlah Dosen**: Berisi informasi jumlah total dosen aktif terdaftar.
  </TabsContent>
  <TabsContent value="struktur">
    ...
    ```
    - **Jumlah Dosen**: Berisi informasi jumlah total dosen aktif terdaftar dengan tipe data number.
  </TabsContent>
</Tabs>