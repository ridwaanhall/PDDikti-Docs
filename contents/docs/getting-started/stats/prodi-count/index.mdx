...
description: Informasi jumlah total program studi terdaftar.
---

Dokumentasi ini menjelaskan cara menggunakan endpoint `Statistik Jumlah Program Studi` dan bagaimana struktur response yang akan Kamu terima. Dengan endpoint ini, Kamu dapat melihat informasi jumlah total program studi terdaftar.

## Endpoint

Untuk mendapatkan informasi jumlah total program studi terdaftar, Kamu dapat menggunakan endpoint berikut:

```plaintext
GET /stats/prodi-count/
```
...
> Dalam contoh ini, API akan mencoba mengambil informasi jumlah total program studi terdaftar.
...
<Tabs defaultValue="python" className="pt-5 pb-1">
  ...
  <TabsContent value="python">
    ...
    url = "https://api-pddikti.ridwaanhall.com/stats/prodi-count"
    api_url = f"{url}/"
  ...
  <TabsContent value="direct">
    Klik untuk mengakses [API directly](https://api-pddikti.ridwaanhall.com/stats/prodi-count/) atau copy text dibawah ini.

    ```plaintext
    https://api-pddikti.ridwaanhall.com/stats/prodi-count/
    ```
...
Response ini berisi informasi jumlah total program studi terdaftar.
...
<Tabs defaultValue="hasil" className="pt-5 pb-1">
  ...
  <TabsContent value="hasil">
    ...
    ```
    - **Jumlah Program Studi**: Berisi informasi jumlah total program studi terdaftar.
  </TabsContent>
  <TabsContent value="struktur">
    ...
    ```
    - **Jumlah Program Studi**: Berisi informasi jumlah total program studi terdaftar dengan tipe data number.
  </TabsContent>
</Tabs>