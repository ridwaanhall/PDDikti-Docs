...
<Tabs defaultValue="python" className="pt-5 pb-1">
  ...
  <TabsContent value="python">
    ...
    url = "https://api-pddikti.vercel.app/stats/prodi-count"
    api_url = f"{url}/"
  ...
  <TabsContent value="direct">
    Klik untuk mengakses [API directly](https://api-pddikti.vercel.app/stats/prodi-count/) atau copy text dibawah ini.

    ```plaintext
    https://api-pddikti.vercel.app/stats/prodi-count/
    ```
