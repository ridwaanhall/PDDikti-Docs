...
<Tabs defaultValue="python" className="pt-5 pb-1">
  ...
  <TabsContent value="direct">
    Klik untuk mengakses [API directly](https://api-pddikti.ridwaanhall.com/mhs/detail/XPj8H-ROOLfFK1k16bsX48FH_fZ3auIW2DX_y6TMoi2wo8jPX8mc25fyU55Vxad8kIMFcA==/) atau copy text dibawah ini.

    ```plaintext
     https://api-pddikti.ridwaanhall.com/mhs/detail/XPj8H-ROOLfFK1k16bsX48FH_fZ3auIW2DX_y6TMoi2wo8jPX8mc25fyU55Vxad8kIMFcA==/
    ```
