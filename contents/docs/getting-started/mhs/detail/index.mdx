...
<Tabs defaultValue="python" className="pt-5 pb-1">
  ...
  <TabsContent value="python">
    ...
    url = "https://api-pddikti.rone.dev/mhs/detail"
  ...
  <TabsContent value="direct">
    Klik untuk mengakses [API directly](https://api-pddikti.rone.dev/mhs/detail/XPj8H-ROOLfFK1k16bsX48FH_fZ3auIW2DX_y6TMoi2wo8jPX8mc25fyU55Vxad8kIMFcA==/) atau copy text dibawah ini.

    ```plaintext
     https://api-pddikti.rone.dev/mhs/detail/XPj8H-ROOLfFK1k16bsX48FH_fZ3auIW2DX_y6TMoi2wo8jPX8mc25fyU55Vxad8kIMFcA==/
    ```
