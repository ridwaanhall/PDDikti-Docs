...
<Tabs defaultValue="python" className="pt-5 pb-1">
  ...
  <TabsContent value="python">
    ...
    url = "https://api-pddikti.rone.dev/search/dosen"
    keyword = "ridwan uty"
  ...
  <TabsContent value="direct">
    Klik untuk mengakses [API directly](https://api-pddikti.rone.dev/search/dosen/ridwan%20uty) atau copy text dibawah ini.

    ```plaintext
    https://api-pddikti.rone.dev/search/dosen/ridwan uty
    ```
