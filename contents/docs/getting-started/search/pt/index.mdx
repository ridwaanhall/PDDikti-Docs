...
description: Endpoint ini digunakan untuk mencari data perguruan tinggi berdasarkan kata kunci.
---

Dokumentasi ini menjelaskan cara menggunakan endpoint `Search PT` dan bagaimana struktur response yang akan Anda terima. Dengan endpoint ini, Anda dapat melakukan pencarian data perguruan tinggi berdasarkan nama, kode, atau singkatan perguruan tinggi.

## Endpoint

Untuk melakukan pencarian data Perguruan Tinggi, Anda dapat menggunakan endpoint berikut:
...
<Tabs defaultValue="python" className="pt-5 pb-1">
  ...
  <TabsContent value="python">
    ...
    url = "https://api-pddikti.vercel.app/search/pt"
    keyword = "uty"
  ...
  <TabsContent value="direct">
    Klik untuk mengakses [API directly](https://api-pddikti.vercel.app/search/pt/uty) atau copy text dibawah ini.

    ```plaintext
    https://api-pddikti.vercel.app/search/pt/uty
    ```
