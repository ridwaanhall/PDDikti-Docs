---
title: Search All
description: Mencari semua data termasuk perguruan tinggi, program studi, dosen, dan mahasiswa.
---

Cara menggunakan endpoint Search All dan hasil response bisa dilihat dibawah ini.
...
> `Keyword` yang digunakan adalah string `ridwan halim uty` yang berarti pencarian berfokus pada nama `ridwan halim` dan memiliki inisial kampus `uty`.
