...
description: Endpoint ini digunakan untuk mencari data mahasiswa berdasarkan kata kunci.
---

Dokumentasi ini menjelaskan cara menggunakan endpoint `Search Mahasiswa` dan bagaimana struktur response yang akan Anda terima. Dengan endpoint ini, Anda dapat melakukan pencarian data mahasiswa berdasarkan nama, NIM, atau kombinasi dengan nama perguruan tinggi.

## Endpoint

Untuk melakukan pencarian data Mahasiswa, Anda dapat menggunakan endpoint berikut:
