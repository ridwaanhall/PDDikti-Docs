...
<Tabs defaultValue="python" className="pt-5 pb-1">
  ...
  <TabsContent value="python">
    ...
    url = "https://api-pddikti.rone.dev/search/mhs"
  ...
  <TabsContent value="direct">
    Klik untuk mengakses [API directly](https://api-pddikti.rone.dev/search/mhs/ridwan%20halim%20informatika%20uty) atau copy text dibawah ini.

    ```plaintext
    https://api-pddikti.rone.dev/search/mhs/ridwan halim informatika uty
    ```
