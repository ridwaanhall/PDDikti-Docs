...
<Tabs defaultValue="python" className="pt-5 pb-1">
  ...
  <TabsContent value="python">
    ...
    url = "https://api-pddikti.rone.dev/pt/logo"
  ...
  <TabsContent value="direct">
    Klik untuk mengakses [API directly](https://api-pddikti.rone.dev/pt/logo/IIrmU70D6TnWs79XzUmnBLmgfQLYxkZzUeQjVW4cA9_WKIIB0oJfhVSNS865-zzStoB4tg==/) atau copy text dibawah ini.

    ```plaintext
     https://api-pddikti.rone.dev/pt/logo/IIrmU70D6TnWs79XzUmnBLmgfQLYxkZzUeQjVW4cA9_WKIIB0oJfhVSNS865-zzStoB4tg==/
    ```
...
<Tabs defaultValue="hasil" className="pt-5 pb-1">
  ...
  <TabsContent value="hasil">
    ...
    ![Logo Perguruan Tinggi](https://api-pddikti.rone.dev/pt/logo/IIrmU70D6TnWs79XzUmnBLmgfQLYxkZzUeQjVW4cA9_WKIIB0oJfhVSNS865-zzStoB4tg==/)
