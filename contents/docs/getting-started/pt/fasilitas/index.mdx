...
Dokumentasi ini menjelaskan cara menggunakan endpoint `Fasilitas PT` dan bagaimana struktur response yang akan Kamu terima. Dengan endpoint ini, Kamu dapat melihat informasi terkait fasilitas pada suatu perguruan tinggi berdasarkan `id_pt`.
