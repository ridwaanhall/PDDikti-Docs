---
title: Waktu Studi
description: Informasi rata-rata masa studi mahasiswa pada suatu perguruan tinggi berdasarkan ID perguruan tinggi.
---

Dokumentasi ini menjelaskan cara menggunakan endpoint `Waktu Studi` dan bagaimana struktur response yang akan Anda terima. Dengan endpoint ini, Anda dapat melihat informasi terkait rata-rata masa studi mahasiswa pada suatu perguruan tinggi berdasarkan `id_pt`.

## Endpoint

Untuk mendapatkan informasi rata-rata masa studi mahasiswa pada suatu Perguruan Tinggi, Anda dapat menggunakan endpoint berikut:
...
<Tabs defaultValue="python" className="pt-5 pb-1">
  ...
  <TabsContent value="python">
    ...
    url = "https://api-pddikti.vercel.app/pt/waktu-studi"
  ...
  <TabsContent value="direct">
    Klik untuk mengakses [API directly](https://api-pddikti.vercel.app/pt/waktu-studi/IIrmU70D6TnWs79XzUmnBLmgfQLYxkZzUeQjVW4cA9_WKIIB0oJfhVSNS865-zzStoB4tg==) atau copy text dibawah ini.

    ```plaintext
     https://api-pddikti.vercel.app/pt/waktu-studi/IIrmU70D6TnWs79XzUmnBLmgfQLYxkZzUeQjVW4cA9_WKIIB0oJfhVSNS865-zzStoB4tg==
    ```
    ...
    [
        {
            "id_sp": "string",
            "jenjang": "string",
            "mean_masa_studi": "number"
        },
        ...
    ]
    ```
    - **Informasi Masa Studi**: Berisi daftar informasi rata-rata masa studi mahasiswa per jenjang, dengan tipe data string untuk ID SP dan jenjang, serta number untuk rata-rata masa studi.
  </TabsContent>
</Tabs>