...
<Tabs defaultValue="python" className="pt-5 pb-1">
  ...
  <TabsContent value="direct">
    Klik untuk mengakses [API directly](https://api-pddikti.ridwaanhall.com/pt/mahasiswa/IIrmU70D6TnWs79XzUmnBLmgfQLYxkZzUeQjVW4cA9_WKIIB0oJfhVSNS865-zzStoB4tg==) atau copy text dibawah ini.

    ```plaintext
     https://api-pddikti.ridwaanhall.com/pt/mahasiswa/IIrmU70D6TnWs79XzUmnBLmgfQLYxkZzUeQjVW4cA9_WKIIB0oJfhVSNS865-zzStoB4tg==
    ```
