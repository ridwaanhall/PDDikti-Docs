...
description: Rasio dosen dan mahasiswa pada suatu perguruan tinggi berdasarkan ID perguruan tinggi.
---

Dokumentasi ini menjelaskan cara menggunakan endpoint `Rasio Dosen dan Mahasiswa` dan bagaimana struktur response yang akan Anda terima. Dengan endpoint ini, Anda dapat melihat rasio dosen dan mahasiswa pada suatu perguruan tinggi berdasarkan `id_pt`.

## Endpoint

Untuk mendapatkan rasio dosen dan mahasiswa pada suatu Perguruan Tinggi, Anda dapat menggunakan endpoint berikut:
