...
<Note type="danger" title="Peringatan">
  Jika kamu mendapati bahwa Dokumentasi API kami belum lengkap atau ada yang tidak berfungsi, silahkan ajukan [issue](https://github.com/ridwaanhall/PDDikti-Docs/issues/new) di GitHub agar segera kami perbaiki.
</Note>
...
├── dosen/teaching-history/<str:id_dosen>/ // riwayat mengajar
...
├── bidang-ilmu-terbanyak/ // jumlah program studi berdasarkan bidang ilmu terbanyak
...
#### Statistik Program Studi Berdasarkan Bidang Ilmu
Statistik program studi berdasarkan bidang ilmu yang ada.

```
prodi
├── bidang-ilmu/agama/      // nama dan jumlah prodi berdasarkan bidang ilmu agama
├── bidang-ilmu/ekonimi/    // nama dan jumlah prodi berdasarkan bidang ilmu ekonomi
├── bidang-ilmu/humaniora/  // nama dan jumlah prodi berdasarkan bidang ilmu humaniora
├── bidang-ilmu/kesehatan/  // nama dan jumlah prodi berdasarkan bidang ilmu kesehatan
├── bidang-ilmu/mipa/       // nama dan jumlah prodi berdasarkan bidang ilmu mipa
├── bidang-ilmu/pendidikan/ // nama dan jumlah prodi berdasarkan bidang ilmu pendidikan
├── bidang-ilmu/pertanian/  // nama dan jumlah prodi berdasarkan bidang ilmu pertanian
├── bidang-ilmu/seni/       // nama dan jumlah prodi berdasarkan bidang ilmu seni
├── bidang-ilmu/sosial/     // nama dan jumlah prodi berdasarkan bidang ilmu sosial
└── bidang-ilmu/teknik/     // nama dan jumlah prodi berdasarkan bidang ilmu teknik
```
