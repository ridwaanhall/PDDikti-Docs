...
<Tabs defaultValue="python" className="pt-5 pb-1">
  ...
  <TabsContent value="python">
    ...
    url = "https://api-pddikti.rone.dev/dosen/teaching-history"
  ...
  <TabsContent value="direct">
    Klik untuk mengakses [API directly](https://api-pddikti.rone.dev/dosen/teaching-history/IQo6xVoM7GH9q3uC1X3uxNKWyaVjUFZPwj1dFHbt4JRKXgzta8ztf1W6I7_HEos-8sIf8A==/) atau copy text dibawah ini.

    ```plaintext
    https://api-pddikti.rone.dev/dosen/teaching-history/IQo6xVoM7GH9q3uC1X3uxNKWyaVjUFZPwj1dFHbt4JRKXgzta8ztf1W6I7_HEos-8sIf8A==/
    ```
