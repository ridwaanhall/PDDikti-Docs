...
<Tabs defaultValue="python" className="pt-5 pb-1">
  ...
  <TabsContent value="python">
    ...
    url = "https://api-pddikti.rone.dev/dosen/pengabdian"
  ...
  <TabsContent value="direct">
    Klik untuk mengakses [API directly](https://api-pddikti.rone.dev/dosen/pengabdian/AtnqXm_IHYxyGVe_q-YfgBBVmNdZ6DQxS1WpDkwFJxrbj8elL8B0y3d9VoLwmXHx8hzD8w==/) atau copy text dibawah ini.

    ```plaintext
    https://api-pddikti.rone.dev/dosen/pengabdian/AtnqXm_IHYxyGVe_q-YfgBBVmNdZ6DQxS1WpDkwFJxrbj8elL8B0y3d9VoLwmXHx8hzD8w==/
    ```
