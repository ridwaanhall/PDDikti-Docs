...
Dokumentasi ini menjelaskan cara menggunakan endpoint `Pengabdian Masyarakat Dosen` dan bagaimana struktur response yang akan Anda terima. Dengan endpoint ini, Anda dapat melihat informasi pengabdian masyarakat dosen berdasarkan `id_dosen`.

## Endpoint

Untuk mendapatkan informasi pengabdian masyarakat Dosen, Anda dapat menggunakan endpoint berikut:
