...
Dokumentasi ini menjelaskan cara menggunakan endpoint `Deskripsi Prodi` dan bagaimana struktur response yang akan Kamu terima. Dengan endpoint ini, Kamu dapat melihat informasi deskripsi program studi berdasarkan `id_prodi`.
