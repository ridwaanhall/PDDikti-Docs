...
<Tabs defaultValue="python" className="pt-5 pb-1">
  ...
  <TabsContent value="direct">
    Klik untuk mengakses [API directly](https://api-pddikti.ridwaanhall.com/prodi/detail/sIU3_7yvFq6ot-F8Hu3d1h0zWf21NkeT4wd-KWCCCFLo26jwAqZAMjDd_xDuloWA8CzNkg==/) atau copy text dibawah ini.

    ```plaintext
    https://api-pddikti.ridwaanhall.com/prodi/detail/sIU3_7yvFq6ot-F8Hu3d1h0zWf21NkeT4wd-KWCCCFLo26jwAqZAMjDd_xDuloWA8CzNkg==/
    ```
