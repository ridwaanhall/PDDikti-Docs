...
Dokumentasi ini menjelaskan cara menggunakan endpoint `Dosen Penghitung Rasio` dan bagaimana struktur response yang akan Anda terima. Dengan endpoint ini, Anda dapat melihat informasi dosen penghitung rasio pada suatu program studi berdasarkan `id_prodi` dan `id_thsmt`.

## Endpoint

Untuk mendapatkan informasi dosen penghitung rasio pada suatu Program Studi, Anda dapat menggunakan endpoint berikut:
